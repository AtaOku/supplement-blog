  ...
  energy: {
    ...
    intermediate: [
      ...
      },
      {
        ...
        link: "/blog/asetil-l-karnitin-faydalar",
        priority: "essential",
      },
      {
    ...
    advanced: [
      {
        ...
        link: "/blog/en-iyi-nmn-takviyesi",
        priority: "essential",
      },
      {
  ...
  longevity: {
    ...
    advanced: [
      ...
      },
      {
        ...
        link: "/blog/taurin-takviyesi-faydalari",
        priority: "essential",
      },
      {
    ...
    beginner: [
      {
        ...
        link: "/urun-inceleme/optimum-nutrition-creatine-review",
        priority: "essential",
      },
      {
        name: "Whey Protein",
        ...
        link: "/urun-inceleme/optimum-nutrition-gold-standard-whey-review",
        priority: "essential",
      },
      {
        name: "Vitamin D3",
...
export default function StackBuilderClient() {
  ...
  const handleCopy = () => {
    ...
    const text = [
      ...
      "",
      `Built with the free Supplement Stack Builder: https://supplementrehberi.com/tools/supplement-stack-builder`,
    ].join("\n");
